...
Examples:
  ...
  python analyze.py --multirun --hyperparam-analysis 2025-08-11_11-45-46   # Hyperparameter analysis
    ...
    if args.hyperparam_analysis:
        ...
        # Handle weights analysis
        if args.multirun:
            # Weights analysis for multirun
            multirun_id, custom_names = parse_multirun_args(args.multirun, args.run_id)
            ...
            # Perform weights analysis
            try:
                plot_weights_analysis_multirun(run_paths, run_labels=custom_names)
            except Exception as e:
                print(f"Error in weights analysis: {e}")
                raise e
                return 1
        else:
            # Weights analysis for single run
            if args.run_id:
                run_id = args.run_id
            else:
                try:
            ...
            # Load log and perform weights analysis
            try:
